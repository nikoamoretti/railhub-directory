-- Railhub Database Schema (No PostGIS version)
-- PostgreSQL 15+
...
CREATE TABLE facilities (
    ...
    -- Geolocation (regular columns without PostGIS)
...
-- Geolocation index (B-tree for range queries)
CREATE INDEX idx_facilities_lat ON facilities(latitude) WHERE latitude IS NOT NULL;
CREATE INDEX idx_facilities_lng ON facilities(longitude) WHERE longitude IS NOT NULL;
